 ...
 * lead to a {@link ItemModelDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 */
public class ItemModelListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_itemmodel_list);
        ...
        if (findViewById(R.id.itemmodel_detail_container) != null) {
        ...
        View recyclerView = findViewById(R.id.itemmodel_list);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    ItemModelDetailFragment fragment = new ItemModelDetailFragment();
                    fragment.setArguments(arguments);
                    mParentActivity.getSupportFragmentManager().beginTransaction()
                            .replace(R.id.itemmodel_detail_container, fragment)
                            .commit();
                } else {
                    Context context = view.getContext();
                    Intent intent = new Intent(context, ItemModelDetailActivity.class);
                    intent.putExtra(ItemModelDetailFragment.ARG_ITEM_ID, item.id);
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.itemmodel_list_content, parent, false);
